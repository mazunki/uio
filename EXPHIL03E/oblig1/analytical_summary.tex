...
% Descartes's Dualism  (mutilabe) %%wcignore
% By Marleen ROZEMOND, Marleen Rozemond %%wcignore
% https://books.google.no/books?id=-qSvoR5tWIYC&sitesec=buy&source=gbs_vpt_read %%wcignore

% imagination == limited %%wcignore
% https://publishing.cdlib.org/ucpressebooks/view?docId=ft0d5n99fd&chunk.id=d0e7671&toc.id=&brand=ucpress %%wcignore
