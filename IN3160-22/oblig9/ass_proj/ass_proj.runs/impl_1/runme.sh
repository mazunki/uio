...
HD_PWD='/uio/hume/student-u81/rolfvh/IN3160-22/oblig9/ass_proj/ass_proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log compute_pipelined.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source compute_pipelined.tcl -notrace
