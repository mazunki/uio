...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set DIR_synch_0 [ create_bd_port -dir O DIR_synch_0 ]
  set EN_synch_0 [ create_bd_port -dir O EN_synch_0 ]
  ...
  # Create instance: fpga_system_0, and set properties
  set fpga_system_0 [ create_bd_cell -type ip -vlnv rolfvh.uio.no:rolfvh:fpga_system:1.0 fpga_system_0 ]
  ...
  connect_bd_net -net SA_0_1 [get_bd_ports SA_0] [get_bd_pins fpga_system_0/SA]
  connect_bd_net -net SB_0_1 [get_bd_ports SB_0] [get_bd_pins fpga_system_0/SB]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins fpga_system_0/gpio]
  connect_bd_net -net fpga_system_0_DIR_synch [get_bd_ports DIR_synch_0] [get_bd_pins fpga_system_0/DIR_synch]
  connect_bd_net -net fpga_system_0_EN_synch [get_bd_ports EN_synch_0] [get_bd_pins fpga_system_0/EN_synch]
  connect_bd_net -net fpga_system_0_abcdefg [get_bd_ports abcdefg_0] [get_bd_pins fpga_system_0/abcdefg]
  connect_bd_net -net fpga_system_0_c [get_bd_ports c_0] [get_bd_pins fpga_system_0/c]
  connect_bd_net -net fpga_system_0_gpio2 [get_bd_pins axi_gpio_0/gpio2_io_i] [get_bd_pins fpga_system_0/gpio2]
  connect_bd_net -net mclk_0_1 [get_bd_ports mclk_0] [get_bd_pins fpga_system_0/mclk]
  ...
  connect_bd_net -net reset_0_1 [get_bd_ports reset_0] [get_bd_pins fpga_system_0/reset]
