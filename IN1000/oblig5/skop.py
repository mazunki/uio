...
def​ minFunksjon​():
	for​ x ​in​ range​(​2​):  # runs the following block of code twice with the values x as 0 and 1, respectively, stored in this function
		...
		​print​(​c)  # prints the value `2` to screen the first time, and then as `3` afterwards
		...
		b ​+=​ a  # causes a NameError Exception, as a is not defined in this function
	   	​​print​(​b​)  # would print `10` on screen if line 19 was ignored
	return​(​b​)  # returns `10` to the output of the function
...
def hovedprogram():  # called by line 33
	...
	print​​(​b​)  # prints the value `42` to screen
	print​​(​a​)  # prints `10` to the screen
